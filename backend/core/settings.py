...
SECRET_KEY = 'django-insecure-q=s7q_ad!+vg!h(eef$eet#m=w+fu5x#jpu510t#f@yi^vx6tm'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "iss_db"),
        "USER": os.getenv("DB_USER", "iss_admin"),
        "PASSWORD": os.getenv("DB_PASSWORD", "iss_password"),
